			...
			<div>
				<c:forEach items="${list}" var="vo">
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<div class="box_top_in contents" style="width: 800px; text-align: left">
											<button class="accordion-button collapsed numCatch" data-num="${vo.num}" type="button" data-bs-toggle="collapse" data-bs-target="#qna-collapse${vo.num}" aria-controls="qna-collapse${vo.num}" aria-expanded="false" >
												${vo.contents}
											</button>
										</div>
					...
					<li style="list-style:none; padding-left: 166px" class="box_top">
						<div id="qna-collapse${vo.num}" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
							<div class="accordion-body">
								...
								<%-- table id="replyResult">
									...
									<c:import url="./qnaReplyList"></c:import>
								</table> --%>
