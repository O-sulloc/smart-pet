		...
		<div class="accordion accordion-flush" id="accordionFlushExample">
		  <div class="accordion-item">
		    ...
		    <h2 class="accordion-header" id="flush-headingOne">
		      <button class="accordion-button collapsed numCatch" data-num="${vo.num}" 
		      type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse${vo.rowNum}" 
		      aria-controls="flush-collapse${vo.rowNum}" aria-expanded="false" >
		    ...
		    <div id="flush-collapse${vo.rowNum}" class="accordion-collapse collapse" 
		    aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
		    
		      <div style="overflow: auto; height: 150px; background-color: #F8F8FF; margin-top: 5px; white-space:pre;" class="accordion-body" >
		      <c:out value="${vo.contents}"/></div>
