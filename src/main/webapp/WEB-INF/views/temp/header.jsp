	      ...
	      <ul class="navbar-nav mb-2 mb-lg-0">
	      	<c:choose>
	      		<c:when test="${not empty user}">
				    <li class="nav-item">
			          <a class="nav-link active" aria-current="page" href="/user/mypage">
			          Mypage <i class="bi bi-person-circle"></i>
			          </a>
			        </li>
			        <li class="nav-item">
			          <a class="nav-link active" href="/user/logout">
	      		...
	      		<c:otherwise>
			        <li class="nav-item">
			          <a class="nav-link active" aria-current="page" href="/user/add">
			          Join <i class="bi bi-person-plus-fill"></i>
			          </a>
			        </li>
			        <li class="nav-item">
			          <a class="nav-link active" href="/user/login">
