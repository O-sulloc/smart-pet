						...
						<div class="row g-3 justify-content-center">							
							<div>
								<div class="col-sm-6">
									...
									<input id="petName" class="form-control" name="petName" value="${pet.petName}">
							...
							<div class="col-sm-12">
								<c:if test="${pet.petKind eq 0}">
									<div class="form-check form-check-inline">
										<input type="radio" class="form-check-input" id="petKind" value="0" name="petKind" checked="checked">
								...
								<c:if test="${pet.petKind eq 1}">
									...
									<div class="form-check form-check-inline">
										<input type="radio" class="form-check-input" id="petKind" value="1" name="petKind" checked="checked">
										<label class="form-check-label" for="petKind1">cat</label>
									</div>
								</c:if>
							</div>
							<div class="col-sm-12">	
								...
								<input type="date" id="petBirth" name="petBirth" min="2000-01-01" max="" value="${pet.petBirth}">
							</div>
							<div class="col-sm-12">	
								<c:if test="${pet.petSex eq 0}">
									<div class="form-check form-check-inline">
										<input type="radio" class="form-check-input" id="petSex" value="0" name="petSex" checked="checked">
								...
								<c:if test="${pet.petSex eq 1}">
									...
									<div class="form-check form-check-inline">
										<input type="radio" class="form-check-input" id="petSex" value="1" name="petSex" checked="checked">
										<label class="form-check-label" for="petSex1">남</label>
									</div>
								</c:if>
							</div>
							...
							<button class="w-100 btn btn-success btn-lg mb-5" type="submit">수정</button>
						</div>
					</form>
				</div>
			</div>
